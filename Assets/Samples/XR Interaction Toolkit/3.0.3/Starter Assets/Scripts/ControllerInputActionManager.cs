...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class ControllerInputActionManager : MonoBehaviour
    {
        ...
        [SerializeField]
        [Tooltip("The interactor used for distant/ray manipulation.")]
        ...
        void OnStartLocomotion(InputAction.CallbackContext context) => m_LocomotionUsers.Add(context.action);
        ...
        {
            // ‘I‘ð’†‚È‚ç locomotion ‚ð–³Œø‰»
            DisableAllLocomotionActions();
        }

        void OnRaySelectExited(SelectExitEventArgs args)
        {
            // ‘I‘ð‚ª‰ðœ‚³‚ê‚½‚ç locomotion ‚ðÄ—LŒø‰»
            UpdateLocomotionActions();
        }
        ...
        protected void OnDisable() => TeardownInteractorEvents();
        ...
        {
            if (enabled) EnableAction(actionReference);
            else DisableAction(actionReference);
        }
